...
export default class App extends React.Component {
  ...
  render() {
    return (
      <div className="App" style={{'position': 'asd'}}>
        ...
        <div className="wrap">
          <p>Meow meow, i tell my human swat at dog. Spit up on light gray carpet instead of adjacent linoleum leave fur on owners clothes lick yarn hanging out of own butt pose purrfectly to show my beauty purr step on your keyboard while you're gaming and then turn in a circle . Hiss and stare at nothing then run suddenly away sleep nap love to play with owner's hair tie. Eat grass, throw it back up. Lick butt and make a weird face slap owner's face at 5am until human fills food dish or kitty poochy stand in front of the computer screen swat at dog, so have my breakfast spaghetti yarn. Always hungry meowwww and nap all day, so climb leg, so when in doubt, wash inspect anything brought into the house. Sniff sniff jump five feet high and sideways when a shadow moves. Sleep nap eat the fat cats food for walk on car leaving trail of paw prints on hood and windshield but sit in box show belly and purr.</p>
        </div>
